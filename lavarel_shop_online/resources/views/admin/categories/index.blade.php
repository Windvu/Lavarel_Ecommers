                    ...
                    <div class="card-header">                       
                        <div class="card-tools">
                            <div class="input-group input-group" style="width: 250px;">
                                ...
                                <button type="button" onclick="window.location.href='{{route('categories.index')}}'">Reset</button>
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$category -> name}}</td>
                                <td>{{$category -> slug}}</td>
                                <td><img src="{{asset('/temp/'.$category->image)}}"   width="100" height="100" alt="{{$category -> name}}" title="{{$category -> name}}" onclick="showImageFullScreen(this.src)"></td>                                       
